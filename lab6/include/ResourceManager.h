...
public:
	...
	// Загружает материал из JSON файла
	// возвращаемое значение - индекс материала в результирующем массиве
	int loadMaterial(const string& filename);
	// получит материал по его индексу
	// если индекс выходит за границы возвращает nullptr
...
private:
	...
	// map для быстрого поиска индекса материала по имени загруженного файла
